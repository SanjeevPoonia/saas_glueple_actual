...
class COFFApplicationBottomSheet extends StatefulWidget {
  @override
  State<COFFApplicationBottomSheet> createState() =>
      _COFFApplicationBottomSheet();
}

class _COFFApplicationBottomSheet extends State<COFFApplicationBottomSheet> {
  int selectedType = 0;
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Current and Required Balance Row
                Row(
                  children: [
                    Container(
                ...
                // Selected C-OFF for Application Title
                Text(
                  "Selected C-OFF for Application",
                  style: TextStyle(color: Colors.grey[700], fontSize: 16),
                ),
                SizedBox(height: 8),

                // Horizontal ListView for C-OFFs
                SizedBox(
                  height: 95, // Increased height to better show the pill
                  child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: 2, // Replace with your actual count
                      ...
                      return SizedBox(
                        ...
                        child: Container(
                          ...
                          margin: EdgeInsets.only(
                            right: 12,
                            top: 15,
                          ), // Add top margin to give more space for pill
                          decoration: BoxDecoration(
                            color: Color(0xFFF6F6F6),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: Stack(
                            clipBehavior: Clip.none, // Allow overflow for pill
                            children: [
                              Padding(
                              ...
                              // Black pill at the top
                              Positioned(
                                top: -15, // Move pill further up for visibility
                                left: 65,
                                right: 65,
                                child: Container(
                    ...
                    onPressed: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) => SuccessfulBottomSheet(
                          title: "C-OFF Application Applied Successfully",
                          type: "C-OFF Application",
                          status: "Pending",
