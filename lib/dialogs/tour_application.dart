...
class TourApplicationBottomSheet extends StatefulWidget {
  @override
  State<TourApplicationBottomSheet> createState() =>
      _TourApplicationBottomSheet();
}

class _TourApplicationBottomSheet extends State<TourApplicationBottomSheet> {
  int selectedType = 0;
                    ...
                    onPressed: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) => SuccessfulBottomSheet(
                          title: "Tour Application Applied Successfully",
